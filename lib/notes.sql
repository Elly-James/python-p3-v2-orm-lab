...
A review includes an attribute for the year as well as a summary of the employee's performance.
...
__init__ initializes attributes for the review year, summary, and associated employee. It also initializes the id attribute to a default value of None.
...
employee_id should be the id of an Employee class instance that has been persisted into the "employees" table.
